...
STARTER_CHECKLIST = [
    ...
    {"id": "llms-txt",      "group": "AI engines",
     "label": "Verify /llms.txt is published",
     "info": "Servia already exposes /llms.txt — a brief site map written for LLMs. Click to verify it loads.",
     "action_url": "https://servia.ae/llms.txt"},
    {"id": "robots-txt-bots","group": "AI engines",
     "label": "Verify robots.txt allows GPTBot/ClaudeBot/PerplexityBot",
     "info": "Servia's robots.txt explicitly allows AI bots (GPTBot, ClaudeBot, PerplexityBot, Google-Extended, etc.) so LLMs can pull cited content. Click to verify.",
     "action_url": "https://servia.ae/robots.txt"},
    {"id": "perplexity",    "group": "AI engines",
     "label": "Perplexity — submit your sources",
     "info": "Step 1: Sign up at perplexity.ai/hub. Step 2: Verify domain ownership. Step 3: After 1-2 weeks of GPT/PerplexityBot crawl, your pages start showing as cited sources.",
     "action_url": "https://www.perplexity.ai/hub"},
    {"id": "openai-search", "group": "AI engines",
     "label": "OpenAI ChatGPT Search index",
     "info": "ChatGPT search uses Bing index + GPTBot direct crawls. Just verify Bing Webmaster (above) + your robots.txt allows GPTBot. No separate signup.",
     "action_url": "https://chatgpt.com/?model=gpt-4o&hints=search"},
    {"id": "claude-citations", "group": "AI engines",
     "label": "Anthropic Claude — content gets cited via web search",
     "info": "Claude with web search uses Brave Search + ClaudeBot crawls. Verify Brave Search + allow ClaudeBot in robots.txt (already done).",
     "action_url": "https://claude.ai/"},
    {"id": "gemini-extended", "group": "AI engines",
     "label": "Google Gemini — allow Google-Extended UA",
     "info": "Gemini training opt-in is controlled by the 'Google-Extended' UA in robots.txt. Servia explicitly allows it (see /robots.txt). No separate signup — Gemini auto-pulls via Google index.",
     "action_url": "https://gemini.google.com/"},
    {"id": "you-com",       "group": "AI engines",
     "label": "You.com / YouBot",
     "info": "You.com runs its own crawler (YouBot). Just allow in robots.txt (already done). No signup form.",
     "action_url": "https://you.com/"},
    {"id": "phind",         "group": "AI engines",
     "label": "Phind — answer engine index",
     "info": "Phind uses Bing + own crawlers. Verify Bing Webmaster (above) covers Phind too.",
     "action_url": "https://phind.com/"},
    {"id": "kagi",          "group": "AI engines",
     "label": "Kagi — premium search index",
     "info": "Kagi indexes from open web + their own bot. Allow KagiBot in robots.txt (Servia already does).",
     "action_url": "https://kagi.com/"},
    {"id": "brave-search",  "group": "AI engines",
     "label": "Brave Search — submit your domain",
     "info": "Free indexing. Brave Search powers DuckDuckGo + Claude's web search. Sign up below.",
     "action_url": "https://search.brave.com/search-creator-platform"},
    {"id": "chatgpt-actions","group": "AI engines",
     "label": "ChatGPT — build a custom GPT for Servia",
     "info": "Step 1: Go to chatgpt.com/gpts/editor. Step 2: 'Create a GPT' → name 'Servia UAE Concierge' → describe what it does. Step 3: Add your /api/chat endpoint as an Action. Step 4: Publish public. Now ChatGPT users can find/use Servia.",
     "action_url": "https://chatgpt.com/gpts/editor"},
    {"id": "claude-projects","group": "AI engines",
     "label": "Anthropic — Claude Projects (admin team)",
     "info": "Optional. Lets your team query Claude with Servia's docs/data attached as project knowledge. Useful for support agents.",
     "action_url": "https://claude.ai/projects"},
    {"id": "schema-test",   "group": "AI engines",
     "label": "Validate Schema.org structured data",
     "info": "Servia emits LocalBusiness + Service + FAQPage + BlogPosting JSON-LD which AI engines parse for citations. Test it here.",
