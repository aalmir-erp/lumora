...
STARTER_VIDEOS = [
    ...
    },
    {
        ...
        "scenes": [
            ...
            {"text": "AED 1,000 damage cover (per visit, subject to T&Cs at /terms)",     "sub": "Background-checked · insured", "anim": "shake"},
...
def _service_video(sid: str, sname: str, emoji: str, mascot: str, tone: str) -> dict:
    return {
        ...
        "scenes": [
            ...
            {"text": "Transparent fixed price", "sub": "AED 1,000 damage cover (per visit, subject to T&Cs at /terms)", "anim": "bounce"},
...
LONG_FORM_VIDEOS = [
    {"slug":"long-ac-pre-summer", "title":"AC pre-summer guide — Servia explainer (60s)",
     ...
     "scenes":[
       ...
       {"text":"💎 7-day re-do guarantee","sub":"AED 1k damage cover","anim":"wave"},
     ]},
    {"slug":"long-deep-clean-truth", "title":"Deep cleaning — what people don't tell you (60s)",
     ...
     "scenes":[
       ...
       {"text":"🛡 AED 1k damage cover","sub":"7-day re-do guarantee","anim":"wave"},
...
GENERIC_VIDEOS = [
    {"slug":"why-servia",       "title":"Why 2,400+ UAE families pick Servia",     "mascot":"default","tone":"teal",
     "scenes":[{"text":"4.9★ from 2,400+","sub":"Real verified reviews","anim":"wave"},
               ...
               {"text":"AED 1,000 damage cover (per visit, subject to T&Cs at /terms)","sub":"On every visit","anim":"shake"}]},
