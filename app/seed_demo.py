...
CUSTOMERS = [
    ...
    ("+971500000001","Aisha Al Mansoori",   "aisha@demo.servia.ae", "ar","aisha123",   500.0, 0,"Dubai Marina",       "Dubai",        "Power user · 12 bookings · 3 NFC tags · healthy wallet"),
    ("+971500000002","Mohammed Khan",       "mohd@demo.servia.ae",  "en","mohd123",    250.0, 0,"Business Bay",       "Dubai",        "Office customer · 3 office_cleaning bookings"),
    ("+971500000003","Priya Sharma",        "priya@demo.servia.ae", "hi","priya123",    75.0, 0,"JLT",                "Dubai",        "Hindi UI · returning · 5 completed bookings"),
    ("+971500000004","Lara Petrov",         "lara@demo.servia.ae",  "ru","lara123",      0.0, 0,"Khalifa City",       "Abu Dhabi",    "Wallet empty · pending unpaid invoice"),
    ("+971500000005","Khalid Rashed",       "khalid@demo.servia.ae","ar","khalid123", 1500.0, 0,"Al Nahda",           "Sharjah",      "Wallet rich · 1500 AED never spent · brand new"),
    ("+971500000006","Mary Dela Cruz",      "mary@demo.servia.ae",  "tl","mary123",     25.0, 0,"Mirdif",             "Dubai",        "Filipino · low wallet · weekly maid auto-renew"),
    ("+971500000007","Ahmed Al Hashemi",    "ahmed@demo.servia.ae", "ar","ahmed123",   800.0, 0,"Al Khawaneej",       "Dubai",        "Villa owner · 14 NFC tags installed · all rooms tagged"),
    ("+971500000008","Sara Williams",       "sara@demo.servia.ae",  "en","sara123",    100.0, 1,"DIFC",               "Dubai",        "BLOCKED · flagged for non-payment"),
    ("+971500000009","Rajesh Iyer",         "raj@demo.servia.ae",   "hi","raj123",     300.0, 0,"Ajman Corniche",     "Ajman",        "Multi-emirate · bookings in Ajman + Dubai + Sharjah"),
    ("+971500000010","Fatima Al Zaabi",     "fatima@demo.servia.ae","ar","fatima123",   50.0, 0,"Al Reem Island",     "Abu Dhabi",    "RTL Arabic UI test · pool + garden + maid weekly"),
    ("+971500000011","Brian O'Neill",       "brian@demo.servia.ae", "en","brian123",   200.0, 0,"Al Barsha",          "Dubai",        "Driver · keychain tag · 8 car_wash + 2 vehicle_recovery"),
    ("+971500000012","Reema Hassan",        "reema@demo.servia.ae", "ar","reema123",   600.0, 0,"Khalidiya",          "Abu Dhabi",    "New mom · babysitting + maid heavy · DHA-trained nanny weekly"),
    ("+971500000013","David Chen",          "david@demo.servia.ae", "en","david123",     0.0, 0,"DAMAC Hills",        "Dubai",        "Pool family · pool weekly + garden + sofa monthly"),
    ("+971500000014","Hessa Al Awar",       "hessa@demo.servia.ae", "ar","hessa123",    80.0, 0,"Al Quoz",            "Dubai",        "Cancelled-heavy · 4 cancellations · trust-tier downgrade test"),
    ("+971500000015","Aditi Mehra",         "aditi@demo.servia.ae", "hi","aditi123",   140.0, 0,"Mussafah",           "Abu Dhabi",    "Refund pending · 1 dispute open · admin escalation queue"),
    ("+971500000016","Harith Al Khamis",    "harith@demo.servia.ae","ar","harith123", 1200.0, 0,"Sharjah Corniche",   "Sharjah",      "Long sleeper · joined 14 months ago · 0 recent activity"),
    ("+971500000017","Sienna Ricci",        "sienna@demo.servia.ae","en","sienna123",  450.0, 0,"Al Reem Island",     "Abu Dhabi",    "Demo showcase · ALL features used · best UX walkthrough"),
    ("+971500000018","Yusuf Al Marri",      "yusuf@demo.servia.ae", "ar","yusuf123",    35.0, 0,"Al Heera",           "Sharjah",      "Recovery user · 3 vehicle_recovery taps · breakdown veteran"),
    ("+971500000019","Khadija Habib",       "khadija@demo.servia.ae","ar","khadija123",750.0, 0,"Khalifa Park",       "Abu Dhabi",    "Eid prep · 8 bundled services · big-bundle discount tier"),
    ("+971500000020","Tessa Lin",           "tessa@demo.servia.ae", "zh","tessa123",   180.0, 0,"Bluewaters",         "Dubai",        "Chinese UI · brand-new + first booking pending payment"),
]
