...
def render_post(slug: str, request: Request | None = None) -> HTMLResponse:
    ...
    schema = {
        ...
        "author": {
            ...
            "knowsAbout": ["home cleaning", "AC maintenance", "handyman services",
                           "pest control", "UAE home services pricing",
                           sv_name, em_pretty]
        },
        "publisher": {"@type": "Organization", "name": "Servia",
                      "url": "https://servia.ae",
                      "logo": {"@type": "ImageObject", "url": "https://servia.ae/brand/servia-icon-1024x1024.png"}},
        "speakable": {"@type": "SpeakableSpecification",
                      "cssSelector": ["h1", ".b-lead", ".b-tldr", ".b-faq dt"]},
