...
(function () {
  ...
  // v1.24.108 — CartoDB Voyager *does* serve local-language labels
  ...
  function mount(target, opts) {
    ...
    btn.onclick = async () => {
      ...
      // v1.24.108 — exit fullscreen so the user can see the chat
      ...
      // v1.24.108 — also collapse the form into a compact "✅ Pinned"
