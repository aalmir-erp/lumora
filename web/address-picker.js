...
(function () {
  ...
  // v1.24.106 — CartoDB Voyager *does* serve local-language labels
  ...
  function mount(target, opts) {
    ...
    btn.onclick = async () => {
      ...
      // v1.24.106 — exit fullscreen so the user can see the chat
      ...
      // v1.24.106 — also collapse the form into a compact "✅ Pinned"
