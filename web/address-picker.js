...
(function () {
  ...
  // v1.24.97 — CartoDB Voyager *does* serve local-language labels
  ...
  function mount(target, opts) {
    ...
    btn.onclick = async () => {
      ...
      // v1.24.97 — exit fullscreen so the user can see the chat
      ...
      // v1.24.97 — also collapse the form into a compact "✅ Pinned"
