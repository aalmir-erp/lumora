...
**Run at:** 2026-05-11T12:25:41.118968Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 30ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "lnowlaDuRiy2P |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 23ms | Sharjah covered: None |

## ❌ #4: Public: GET /api/services + /api/brand + /api/i18n
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 21ms | 0 services |
| ✗ GET /api/brand | 404 | 37ms | phone: None |
| ✗ GET /api/i18n | 404 | 41ms | 4 languages |

## ❌ #5: Anonymous: book general cleaning 2BR via chat
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (book) | 404 | 23ms | booking_id: None |
...
| ✗ GET /admin/vendors | 404 | 29ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 16ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 15ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 16ms | null |
