...
**Run at:** 2026-05-06T00:06:47.538531Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 168ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "BNiqBIkTRRaDp |
...
| ✗ GET /api/brand | 404 | 128ms | phone: None |
| ✗ GET /api/i18n | 404 | 148ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 169ms | vendor_id=None, token len=0 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 152ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 127ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 129ms | 0 services |
