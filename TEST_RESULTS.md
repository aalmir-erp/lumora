...
**Run at:** 2026-05-05T20:33:50.561591Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 148ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 139ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "E8POL7KMRqaz8 |
...
| ✗ GET /api/brand | 404 | 155ms | phone: None |
| ✗ GET /api/i18n | 404 | 223ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 142ms | booking_id: None |

## ❌ #7: Customer: OTP request + verify (login flow)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 189ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 120ms | vendor_id=None, token len=0 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 231ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 142ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 119ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 156ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 204ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 131ms | 0 vendors offering |
