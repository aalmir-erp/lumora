...
**Run at:** 2026-05-11T12:09:28.993858Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 92ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "02TFZ8HySEiu1 |
...
| ✗ GET /api/brand | 404 | 111ms | phone: None |
| ✗ GET /api/i18n | 404 | 116ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 198ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| ✗ GET /admin/vendors | 404 | 91ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 76ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 85ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 79ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 79ms | 0 vendors offering |

## ❌ #20: Public: GET /api/reviews/deep_cleaning
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 86ms | count=None, avg=None |
