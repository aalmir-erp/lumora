...
**Run at:** 2026-05-05T20:19:42.329722Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 66ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 35ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "8t8LEX6cRT-8h |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 13ms | Sharjah covered: None |
...
| ✗ GET /api/i18n | 404 | 42ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 35ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 39ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 14ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 38ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 14ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 39ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 59ms | 0 vendors offering |
