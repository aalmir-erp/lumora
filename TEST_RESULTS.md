...
**Run at:** 2026-05-06T06:43:52.394437Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 128ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 37ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "b1FF8DC_TW61T |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 37ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 12ms | 0 vendors |
...
| ✗ POST /admin/brand (no-op) | 404 | 32ms | null |
