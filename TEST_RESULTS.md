...
**Run at:** 2026-05-10T10:20:13.269124Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 166ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 96ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "VAEO7F7sQciPs |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 110ms | Sharjah covered: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 71ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| ✗ GET /admin/vendors | 404 | 94ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 73ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 107ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 94ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 96ms | 0 vendors offering |

## ❌ #20: Public: GET /api/reviews/deep_cleaning
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 71ms | count=None, avg=None |
