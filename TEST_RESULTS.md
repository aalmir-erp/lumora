...
**Run at:** 2026-05-06T15:37:47.519164Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 133ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "NYS8lYMQSVCee |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 124ms | Sharjah covered: None |

## ❌ #4: Public: GET /api/services + /api/brand + /api/i18n
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 166ms | 0 services |
| ✗ GET /api/brand | 404 | 135ms | phone: None |
| ✗ GET /api/i18n | 404 | 173ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 155ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 170ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 141ms | 0 vendors |
...
| ✗ POST /admin/brand (no-op) | 404 | 132ms | null |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 153ms | count=None, avg=None |
