...
**Run at:** 2026-05-16T13:58:57.463340Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 33ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "FfiPs_n8R2OF1 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 24ms | 0 services |
| ✗ GET /api/brand | 404 | 30ms | phone: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 41ms | vendor_id=None, token len=0 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 13ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 15ms | 0 vendors |
