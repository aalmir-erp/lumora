...
**Run at:** 2026-05-05T20:15:59.823346Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 313ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 168ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "NsLpx2hlQGCqr |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 127ms | 0 services |
| ✗ GET /api/brand | 404 | 181ms | phone: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 132ms | booking_id: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 138ms | vendor_id=None, token len=0 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 179ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 126ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 155ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 163ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 150ms | null |
