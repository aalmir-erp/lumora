...
**Run at:** 2026-05-10T19:45:20.705459Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 262ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 136ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "YY_9OQr2QM6bp |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 142ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 158ms | vendor_id=None, token len=0 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 134ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 134ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 134ms | 0 services |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 130ms | 0 vendors offering |

## ❌ #20: Public: GET /api/reviews/deep_cleaning
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 188ms | count=None, avg=None |
