...
**Run at:** 2026-05-06T20:01:18.406904Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 121ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 89ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "sabvPH2MTQi1O |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 85ms | 0 services |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (book) | 404 | 94ms | booking_id: None |
...
| ✗ POST /admin/brand (no-op) | 404 | 98ms | null |
