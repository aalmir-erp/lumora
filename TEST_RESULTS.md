...
**Run at:** 2026-05-09T21:44:29.152321Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 57ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 28ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "aC-4kFsJSNO2T |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 44ms | 0 services |
| ✗ GET /api/brand | 404 | 68ms | phone: None |
...
| ✗ GET /admin/vendors | 404 | 41ms | 0 vendors |
...
| ✗ POST /admin/brand (no-op) | 404 | 25ms | null |
