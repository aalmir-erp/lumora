...
**Run at:** 2026-05-05T19:12:26.406985Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 190ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 91ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "tS8EjPuBSquQR |
...
| ✗ GET /api/brand | 404 | 90ms | phone: None |
| ✗ GET /api/i18n | 404 | 95ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 76ms | booking_id: None |
...
| ✗ GET /admin/services-summary | 404 | 82ms | 0 services |
