...
**Run at:** 2026-05-05T23:55:22.436748Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 84ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "MzelHiSlQ3qx_ |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 83ms | Sharjah covered: None |

## ❌ #4: Public: GET /api/services + /api/brand + /api/i18n
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 111ms | 0 services |
| ✗ GET /api/brand | 404 | 88ms | phone: None |
| ✗ GET /api/i18n | 404 | 85ms | 4 languages |

## ❌ #5: Anonymous: book general cleaning 2BR via chat
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (book) | 404 | 85ms | booking_id: None |
...
| ✗ GET /admin/services-summary | 404 | 106ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 82ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 90ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 200ms | 0 vendors offering |
