...
**Run at:** 2026-05-09T22:04:43.081882Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 24ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "-nku68IFR8-CR |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 79ms | Sharjah covered: None |

## ❌ #4: Public: GET /api/services + /api/brand + /api/i18n
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 18ms | 0 services |
| ✗ GET /api/brand | 404 | 35ms | phone: None |
| ✗ GET /api/i18n | 404 | 25ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 17ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 32ms | vendor_id=None, token len=0 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 25ms | 0 vendors offering |
