...
**Run at:** 2026-05-05T23:17:49.611714Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 112ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 85ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "S83j6uG3QYa22 |
...
| ✗ GET /api/i18n | 404 | 81ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 87ms | booking_id: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 98ms | bookings_today=None, total=None |
...
| ✗ POST /admin/brand (no-op) | 404 | 109ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 95ms | 0 vendors offering |
