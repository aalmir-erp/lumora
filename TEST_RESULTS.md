...
**Run at:** 2026-05-05T19:48:43.083580Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 92ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "IlvgFU09S5map |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 96ms | Sharjah covered: None |

## ❌ #4: Public: GET /api/services + /api/brand + /api/i18n
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 86ms | 0 services |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 90ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 83ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 83ms | 0 services |
