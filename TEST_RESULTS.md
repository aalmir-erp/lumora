...
**Run at:** 2026-05-05T20:26:18.259990Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 39ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "OokAVfAtQICT5 |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 35ms | Sharjah covered: None |

## ❌ #4: Public: GET /api/services + /api/brand + /api/i18n
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 30ms | 0 services |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 37ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 34ms | vendor_id=None, token len=0 |
...
| ✗ GET /admin/vendors | 404 | 46ms | 0 vendors |
