...
**Run at:** 2026-05-07T14:49:11.160657Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 131ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 87ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "kBxhMMQ9TEusN |
...
| ✗ GET /api/brand | 404 | 81ms | phone: None |
| ✗ GET /api/i18n | 404 | 105ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 85ms | booking_id: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 99ms | vendor_id=None, token len=0 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 143ms | bookings_today=None, total=None |
