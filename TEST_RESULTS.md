...
**Run at:** 2026-05-08T03:52:36.745422Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 110ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "MmH1nLZpT2eCk |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 94ms | Sharjah covered: None |

## ❌ #4: Public: GET /api/services + /api/brand + /api/i18n
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 93ms | 0 services |
| ✗ GET /api/brand | 404 | 105ms | phone: None |
| ✗ GET /api/i18n | 404 | 97ms | 4 languages |

## ❌ #5: Anonymous: book general cleaning 2BR via chat
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (book) | 404 | 78ms | booking_id: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 72ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| ✗ GET /admin/vendors | 404 | 73ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 75ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 84ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 107ms | null |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 78ms | count=None, avg=None |
