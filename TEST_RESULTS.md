...
**Run at:** 2026-05-15T09:24:48.170655Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 18ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "fONW2JEeRpSHc |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 17ms | 0 services |
| ✗ GET /api/brand | 404 | 17ms | phone: None |
| ✗ GET /api/i18n | 404 | 19ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 21ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 37ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 10ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 12ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 13ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 27ms | 0 vendors offering |
