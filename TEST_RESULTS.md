...
**Run at:** 2026-05-05T23:30:09.217093Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 163ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 83ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "oXy036z0QYWOb |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 80ms | 0 services |
| ✗ GET /api/brand | 404 | 86ms | phone: None |
| ✗ GET /api/i18n | 404 | 86ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 79ms | booking_id: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 83ms | vendor_id=None, token len=0 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 84ms | bookings_today=None, total=None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 82ms | phone=None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 82ms | count=None, avg=None |
