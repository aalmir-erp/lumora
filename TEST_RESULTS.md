...
**Run at:** 2026-05-11T15:38:24.887644Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 32ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "MHBf6p1_RqyqW |
...
| ✗ GET /api/i18n | 404 | 12ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 11ms | booking_id: None |
...
| ✗ GET /admin/vendors | 404 | 10ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 31ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 12ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 12ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 11ms | 0 vendors offering |
