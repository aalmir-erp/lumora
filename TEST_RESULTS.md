...
**Run at:** 2026-05-05T23:37:33.020206Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 83ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 37ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "168pwnYNRwS2W |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 25ms | 0 services |
| ✗ GET /api/brand | 404 | 15ms | phone: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 23ms | booking_id: None |
...
| ✗ GET /admin/vendors | 404 | 13ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 17ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 18ms | phone=None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 38ms | count=None, avg=None |
