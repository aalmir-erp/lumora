...
**Run at:** 2026-05-11T06:32:28.761615Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 84ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "j-nvKzzqQni0n |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 114ms | 0 services |
| ✗ GET /api/brand | 404 | 96ms | phone: None |
| ✗ GET /api/i18n | 404 | 84ms | 4 languages |

## ❌ #5: Anonymous: book general cleaning 2BR via chat
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (book) | 404 | 83ms | booking_id: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 209ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 82ms | vendor_id=None, token len=0 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 85ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 77ms | 0 vendors |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 80ms | 0 vendors offering |
