...
**Run at:** 2026-05-05T21:12:23.987888Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 61ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 46ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "odIoT0N_Q2ixO |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 41ms | Sharjah covered: None |

## ❌ #4: Public: GET /api/services + /api/brand + /api/i18n
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 29ms | 0 services |
| ✗ GET /api/brand | 404 | 31ms | phone: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 33ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 38ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 27ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 42ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 31ms | null |
