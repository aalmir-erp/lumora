...
**Run at:** 2026-05-10T20:40:39.231742Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 119ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 95ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "qnPup_78S-W7H |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 104ms | 0 services |
| ✗ GET /api/brand | 404 | 140ms | phone: None |
| ✗ GET /api/i18n | 404 | 92ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 95ms | booking_id: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 159ms | vendor_id=None, token len=0 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 190ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 87ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 203ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 227ms | phone=None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 111ms | count=None, avg=None |
