...
**Run at:** 2026-05-06T09:02:09.623720Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 92ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "mleVZhMXQXG1E |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 84ms | no dev_otp returned (WhatsApp bridge active or production mode) |
