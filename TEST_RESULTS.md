...
**Run at:** 2026-05-05T19:52:05.575135Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 210ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 150ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "4b2BawBsS3GD0 |
...
| ✗ GET /api/brand | 404 | 146ms | phone: None |
| ✗ GET /api/i18n | 404 | 155ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 125ms | booking_id: None |
...
| ✗ GET /admin/services-summary | 404 | 147ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 153ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 148ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 274ms | 0 vendors offering |
