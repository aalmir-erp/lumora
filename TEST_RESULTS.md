...
**Run at:** 2026-05-05T19:26:47.622527Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 206ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 138ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "Ii5W5jehTWuT1 |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 165ms | 0 services |
| ✗ GET /api/brand | 404 | 152ms | phone: None |
| ✗ GET /api/i18n | 404 | 160ms | 4 languages |

## ❌ #5: Anonymous: book general cleaning 2BR via chat
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (book) | 404 | 118ms | booking_id: None |

## ❌ #6: Anonymous: book AC cleaning 4 units
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 116ms | booking_id: None |

## ❌ #7: Customer: OTP request + verify (login flow)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 136ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 205ms | vendor_id=None, token len=0 |
...
| ✗ GET /admin/vendors | 404 | 123ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 121ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 135ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 134ms | null |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 144ms | count=None, avg=None |
