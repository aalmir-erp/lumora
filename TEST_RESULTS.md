...
**Run at:** 2026-05-05T19:19:29.063264Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 123ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 78ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "YDNwhh6VQ36aI |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 43ms | Sharjah covered: None |

## ❌ #4: Public: GET /api/services + /api/brand + /api/i18n
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 14ms | 0 services |
| ✗ GET /api/brand | 404 | 14ms | phone: None |
| ✗ GET /api/i18n | 404 | 112ms | 4 languages |

## ❌ #5: Anonymous: book general cleaning 2BR via chat
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (book) | 404 | 39ms | booking_id: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 41ms | phone=None |
