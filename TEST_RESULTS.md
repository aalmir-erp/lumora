...
**Run at:** 2026-05-08T07:57:19.195702Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 160ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 87ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "Wlsf2ChZTtSgo |
...
| ✗ GET /admin/services-summary | 404 | 87ms | 0 services |
