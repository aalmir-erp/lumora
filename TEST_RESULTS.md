...
**Run at:** 2026-05-09T21:32:37.197584Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 86ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "HfhsEXS6Q4Oet |
...
| ✗ GET /api/brand | 404 | 79ms | phone: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 104ms | booking_id: None |

## ❌ #7: Customer: OTP request + verify (login flow)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 90ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 115ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 104ms | 0 vendors |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 87ms | 0 vendors offering |
