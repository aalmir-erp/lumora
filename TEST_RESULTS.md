...
**Run at:** 2026-05-16T08:19:49.717745Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 53ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 38ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "Xj_9cMb4Suez7 |
...
| ✗ GET /api/i18n | 404 | 13ms | 4 languages |

## ❌ #5: Anonymous: book general cleaning 2BR via chat
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (book) | 404 | 32ms | booking_id: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 41ms | no dev_otp returned (WhatsApp bridge active or production mode) |
