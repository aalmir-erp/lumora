...
**Run at:** 2026-05-05T20:12:32.631198Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 142ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 39ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "TXvfi0I-Tb61t |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (book) | 404 | 20ms | booking_id: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 18ms | vendor_id=None, token len=0 |
...
| ✗ POST /admin/brand (no-op) | 404 | 41ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 38ms | 0 vendors offering |
