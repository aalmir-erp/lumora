...
**Run at:** 2026-05-15T14:34:18.682310Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 237ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 95ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "_wx-w9exSnmHI |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 115ms | Sharjah covered: None |
...
| ✗ GET /api/i18n | 404 | 108ms | 4 languages |
...
| ✗ GET /admin/vendors | 404 | 92ms | 0 vendors |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 74ms | count=None, avg=None |
