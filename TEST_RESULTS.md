...
**Run at:** 2026-05-05T08:27:44.915832Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 32ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "xa-XfsKlQou6z |
...
| ✗ GET /api/i18n | 404 | 35ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (AC book) | 404 | 34ms | booking_id: None |

## ❌ #7: Customer: OTP request + verify (login flow)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 75ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| ✗ POST /admin/brand (no-op) | 404 | 56ms | null |

## ❌ #19: Admin: service detail (vendors + pricing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/service/deep_cleaning | 404 | 146ms | 0 vendors offering |
