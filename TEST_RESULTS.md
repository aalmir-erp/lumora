...
**Run at:** 2026-05-07T19:53:39.135662Z
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 32ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "PlflmN8jQZCUK |

## ❌ #3: Anonymous: coverage check Sharjah
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (coverage) | 404 | 114ms | Sharjah covered: None |
...
| ✗ GET /admin/services-summary | 404 | 36ms | 0 services |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 10ms | count=None, avg=None |
