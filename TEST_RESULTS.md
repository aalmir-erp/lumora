...
**Run at:** 2026-05-14T08:50:34.277245Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 118ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 96ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "TFkGFKUASTWSM |
...
| ✗ GET /api/brand | 404 | 92ms | phone: None |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /auth/vendor/login | 404 | 79ms | vendor_id=None, token len=0 |
...
| ✗ GET /admin/vendors | 404 | 84ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 88ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 133ms | phone=None |
| ✗ POST /admin/brand (no-op) | 404 | 89ms | null |
