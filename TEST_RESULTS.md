...
**Run at:** 2026-05-05T19:39:56.183467Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 200ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 151ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "VxPgZJDcSqqWu |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/services | 404 | 123ms | 0 services |
| ✗ GET /api/brand | 404 | 130ms | phone: None |
| ✗ GET /api/i18n | 404 | 124ms | 4 languages |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ OTP issue | 404 | 124ms | no dev_otp returned (WhatsApp bridge active or production mode) |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/stats | 404 | 148ms | bookings_today=None, total=None |
| ✗ GET /admin/vendors | 404 | 146ms | 0 vendors |
| ✗ GET /admin/services-summary | 404 | 131ms | 0 services |

## ❌ #18: Admin: read brand, no-op patch (preserve existing)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /admin/brand | 404 | 150ms | phone=None |
