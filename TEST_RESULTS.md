...
**Run at:** 2026-05-16T04:00:00.637164Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 110ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 85ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "sq9_MzLfR5i0S |
...
| ✗ GET /api/brand | 404 | 95ms | phone: None |
...
| ✗ GET /admin/vendors | 404 | 78ms | 0 vendors |
...
| ✗ POST /admin/brand (no-op) | 404 | 97ms | null |
