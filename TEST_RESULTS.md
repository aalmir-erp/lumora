...
**Run at:** 2026-05-05T22:45:54.509803Z
...
|---|---|---|---|
| ✗ POST /api/chat | 404 | 59ms | text len=0, has AED: False, has tool_call: False |

## ❌ #2: Anonymous: deep clean 3BR with addons (oven, fridge)
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ POST /api/chat (with addons) | 404 | 32ms | total: None AED — err: {"status": "error", "code": 404, "message": "Application not found", "request_id": "Ox5iF3jSQdmDz |
...
| ✗ POST /admin/brand (no-op) | 404 | 26ms | null |
...
| Step | Code | Time | Result |
|---|---|---|---|
| ✗ GET /api/reviews/deep_cleaning | 404 | 32ms | count=None, avg=None |
